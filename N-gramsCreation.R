...
#myRDS <- readRDS(paste0(myGenDataDir,"/myNewCorpus.RData"))
#load(myRDS)
#library(readr)
#read_rds(paste0(myGenDataDir,"/myNewCorpus.RData"))
library(quanteda)
...
setwd(myReportsDir)
jpeg("topunigramPlot.jpg")
jpeg("topbigramPlot.jpg")
jpeg("toptrigramPlot.jpg")
jpeg("topquadgramPlot.jpg")
...
# remove Global Environment objects that are not required anymore 
...
setwd(myGenDataDir)
neededObjects <- c("unigramDf_sorted",
                   "bigramDf_sorted",
                   "trigramDf_sorted",
                   "quadgramDf_sorted",
                   "ngramDf_sorted",
