...
setwd(myReportsDir)
write.csv(stat,file = "fileStatistics.csv",col.names = T)
...
setwd(myGenDataDir)
neededObjects <- c("rawDataFileReadTime",
                   "stat",
                   "myScriptsDir")
...
# The program is intended primarily to save some sample files to local.
